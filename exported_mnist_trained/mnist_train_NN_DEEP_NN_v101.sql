-- Sergio Rivera 2023
--
-- Training a NN model with 4 hidden layers
--  neurons per layer: 215,30,30,5
...
--  The default value is NNET_ACTIVATIONS_LOG_SIG.
        '''NNET_ACTIVATIONS_RELU'',''NNET_ACTIVATIONS_RELU'',''NNET_ACTIVATIONS_RELU'',''NNET_ACTIVATIONS_RELU'''
    );
...
BEGIN
   DBMS_DATA_MINING.CREATE_MODEL(
      ...
      mining_function     => dbms_data_mining.classification, -- classification
